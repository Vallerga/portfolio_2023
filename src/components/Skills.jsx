    ...
    <Row className="d-flex">
      <Col className="d-flex flex-column align-items-center">
        <p className="text-center w-75">
          I am a Junior Web Developer who has been studying Computer Science for
          over a year. <br /> My other skills include over 10 years of
          experience in customer-service, team-working, problem-solving.
          <br /> I am interested in both Front-End and Back-End positions and I
          am willing to relocate for the right opportunity anywhere whithin the
          EU.
        </p>
      </Col>
      <Col>
